...
export const metadata: Metadata = {
  ...
  description:
    "UnifyAPI gives AI agents a single MCP endpoint and one billing rail to access hundreds of API tools across many providers. Pay per call with x402.",
};
...
const SOCIALS: { label: string; href: string; icon: React.ReactNode }[] = [
  ...
  {
    label: "GitHub",
    href: "https://github.com/unifyapi",
    icon: (
